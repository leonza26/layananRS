                    ...
                    @foreach ($dokters as $dokter)
                        <div
                            ...
                            <img class="w-full h-48 object-cover"
                                src="https://placehold.co/400x300/3B82F6/FFFFFF?text=Dr.+Andi" alt="Foto Dr. Andi Budiman">
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-800">{{ $dokter->name }}
                                <p class="text-blue-600 font-semibold mt-1">{{ $dokter->dokter->specialization }}</p>
