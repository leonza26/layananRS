...
@section('admin_content')
    ...
    <div id="deleteConfirmationModal" class="fixed z-20 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title"
        role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div id="delete-modal-overlay" class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const openDeleteModal = (formId, patientName) => {
                formToSubmit = formId;
                const message =
                    `Apakah Anda yakin ingin menghapus pasien bernama <strong>${patientName}</strong>? Tindakan ini tidak dapat dibatalkan.`;
