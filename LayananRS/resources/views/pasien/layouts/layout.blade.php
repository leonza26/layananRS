        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <aside class="lg:col-span-3 mb-8 lg:mb-0">
                <div class="bg-white rounded-lg shadow p-4">
                    ...
                    <nav class="space-y-1">
                        <a href="{{ route('pasien') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('patient.summary') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                            Ringkasan
                        </a>
                        <a href="#" class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('history.index') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            Riwayat Janji Temu
                        </a>
                        <a href="{{ route('pasien.profile.saya') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('patient.profile') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100' }}">
